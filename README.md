...
**_1. Расскажите про new, delete, malloc, free, как они связаны и чем отличаются?_**
...
**_2. Бывает такое, что оператор new не выделяет память?_**
...
**_3. Отличия между оператором delete, delete[]._**

**Ответ:** первый выполняет единичный вызов деструктора, а второй оператор - вызывает деструктор
для каждого элемента массива.

**_4. Что такое инкапсуляция, наследование, полиморфизм?_**
...
**_5. Расскажите про порядок вызова конструкторов и деструкторов базового и производного классов при создании
и удалении объекта._**
...
**_6. Что такое виртуальные функции? Что такое чисто виртуальные функции и чисто
виртуальный деструктор? Что такое абстрактный класс?_**
...
**_7. Может ли конструктор и деструктор быть виртуальными?_**
...
**_8. Какое значение будет выведено на экран:_**
...
**_9. Что такое ссылка? Как можно инициализировать ссылку одной или другой переменной в
зависимости от условия?_**
...
**_10. В чем отличие структуры и объединения?_**
...
**_11. Может ли шаблонная функция быть виртуальной?_**
...
**_12. Бывает ли специализация шаблона? Что такое частичная специализация?_**
