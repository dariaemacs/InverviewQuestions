...
###5. Расскажите про порядок вызова конструкторов и деструкторов базового и производного классов при создании
и удалении объекта.
...
###29. Назовите отличия ссылки и указателя?
...
###31. Что выведет на экран следующая программа?
